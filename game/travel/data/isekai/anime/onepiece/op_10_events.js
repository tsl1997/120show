...
window.OP_STORIES.push(
  ...
  { id: 'opv_zoro_mihawk', name: '索隆败给鹰眼·剑士的誓言', icon: '⚔️', desc: '巴拉蒂海上的第一次决斗，黑刀夜碾过三刀流。"背后的伤痛是剑士的耻辱！"跪下的索隆向鹰眼立誓成为世界第一剑豪。' },
  { id: 'opv_sanji_zeff', name: '山治与哲普的告别', icon: '🍴', desc: '巴拉蒂餐厅的黄昏，山治跪谢恩师。哲普把一切押在他身上——"好好去找 ALL BLUE 吧。"海上餐厅的谢幕礼。' },
  { id: 'opv_nami_village', name: '娜美的橘子园与贝尔梅尔', icon: '🍊', desc: '"我的女儿们都很可爱"——贝尔梅尔把最后一口面包让给女儿。娜美抱着橘园痛哭，路飞把草帽扣在她头上：阿龙必须打飞！' },
  { id: 'opv_shanks_bet', name: '香克斯把未来押在路飞身上', icon: '👒', desc: '山贼闹事后香克斯断了一条手臂才救回路飞。"不要小看我的伤疤"——他把草帽交给他，赌上了整片大海的未来。' },
  { id: 'opv_final_saga', name: '最终章的预告', icon: '🏁', desc: '拉夫坦路的四块路标已集齐三块。草帽团与黑胡子、红发、世界政府的最终航海——传说的终幕在等待。' }
);
